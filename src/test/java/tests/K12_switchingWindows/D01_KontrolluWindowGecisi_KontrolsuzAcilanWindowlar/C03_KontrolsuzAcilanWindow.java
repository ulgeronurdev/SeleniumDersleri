...
public class C03_KontrolsuzAcilanWindow extends TestBase_Each {
    ...
    public void test01(){
        ...
        String ilkWindowsWhd = driver.getWindowHandle();
        ...
        System.out.println("ilk window whd : " + ilkWindowsWhd);
        ...
        for (String eacWhd : acikTumWindowlarinWhdSeti) {
    ...
    //● Acilan yeni pencerenin sayfa başlığının (title) “New Window” oldugunu test edin
        ...
        driver.switchTo().window(ilkWindowsWhd);
